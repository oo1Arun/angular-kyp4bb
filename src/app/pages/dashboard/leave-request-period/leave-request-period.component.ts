...
//services
import { adata } from '../../../../@akt/shared/data';
import { ChartDataModel } from '../../../../@akt/interface/chartData';
import { ReportService } from '../../../../@akt/services/dashboard-report/report.service';

@Component({
  selector: 'app-leaverequestperiod',
  templateUrl: './leave-request-period.component.html',
  styleUrls: ['./leave-request-period.component.css']
})
